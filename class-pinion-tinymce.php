...
/*
 * Pinion TinyMCE Plugin
 * TinyMCE plugin for pinion on WordPress editor.
 *
 * @since 0.4.0
 */
...
class PinionTinyMCE {
	...
	*/
	...
	function init() {
		...
		// Add pinion button to the TinyMCE editor
	...
	*/
	...
	function register_tinymce_js( $plugin_array ) {
		$plugin_array[ $this->name ] = plugins_url( 'js/pinion-tinymce.js' , __FILE__ );
		return $plugin_array;
	}
}
